        ...
        catch (Exception ex)
        {
            return StatusCode(
                ...
                ApiResponse<object>.Error(
                    500, 
                    $"An error occurred while retrieving the amenity with id {id}", 
                    ex.Message));
        }
    ...
    public async Task<ActionResult<ApiResponse<VillaAmenitiesDTO>>> UpdateAmenity([FromRoute] int id, [FromBody] VillaAmenitiesUpdateDTO villaAmenitiesUpdateDTO)
    {
        ...
        catch (Exception ex)
        {
            return StatusCode(
                ...
                ApiResponse<object>.Error(
                    500, 
                    $"An error occurred while updating the amenity with id {id}", 
                    ex.Message));
        }
    }
    ...
    public async Task<ActionResult<ApiResponse<object>>> DeleteAmenity([FromRoute] int id)
    {
        ...
        catch (Exception ex)
        {
            return StatusCode(
                ...
                ApiResponse<object>.Error(
                    500, 
                    $"An error occurred while deleting the amenity with id {id}", 
                    ex.Message));
        }
    }
